...
Page({
    ...
    getOrder: function(a) {
        ...
        wx.request({
            ...
            url: t.data.baseurl + "doPageOrderinfo",
            data: {
                order: a,
                openid: e,
                uniacid: t.data.uniacid
    ...
    save: function() {
        ...
        return c || 2 != t.data.datas.pro_flag_tel ? /^(((13[0-9]{1})|(15[0-9]{1})|(17[0-9]{1})|(18[0-9]{1}))+\d{8})$/.test(c) || 2 != t.data.datas.pro_flag_tel ? u || 2 != t.data.datas.pro_flag_add ? void (p && wx.request({
